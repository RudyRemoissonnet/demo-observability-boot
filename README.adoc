...
oc process -f openshift/sb-template.yml -p APP=app-boot-2 | oc create -f -
oc process -f openshift/sb-template.yml -p APP=app-boot-3 | oc create -f -
oc process -f openshift/sb-template.yml -p APP=app-server | oc create -f -
oc process -f openshift/sb-template.yml -p APP=app-client | oc create -f -
----
